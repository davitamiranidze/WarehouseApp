...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("StockItemsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheStockItemsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheStockItemsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheStockItemsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheStockItemsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheStockItemsListGenerated.onTable().iPressRow(0);
            Then.onTheStockItemsObjectPageGenerated.iSeeThisPage();
